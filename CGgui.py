...
class Ui_MainWindow(object):
    ...
    def field(self, MainWindow):
        x = int(self.field_x.text())
        y = int(self.field_y.text())
        draw.FieldFill.boundary(x, y)
    ...
    def setupUi(self, MainWindow):
        ...
        self.field_x = QtWidgets.QLineEdit(self.horizontalLayoutWidget_4)
        self.field_x.setObjectName("field_x")
        self.horizontalLayout.addWidget(self.field_x)
        self.label_41 = QtWidgets.QLabel(self.horizontalLayoutWidget_4)
        self.label_41.setObjectName("label_41")
        self.horizontalLayout.addWidget(self.label_41)
        self.field_y = QtWidgets.QLineEdit(self.horizontalLayoutWidget_4)
        self.field_y.setObjectName("field_y")
        self.horizontalLayout.addWidget(self.field_y)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.field_x.setText(_translate("MainWindow", "61"))
        self.label_41.setText(_translate("MainWindow", "y"))
        self.field_y.setText(_translate("MainWindow", "25"))
